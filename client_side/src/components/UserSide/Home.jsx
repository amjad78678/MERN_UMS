...
const Home = () => {
  ...
  return (
    <>
     ...
     <div style={{backgroundImage: 'url("/gradi.jpg")'}} className='grid grid-cols-12  object-cover bg-no-repeat'> 
     <span className='col-span-3'></span>
     <div className='col-span-6 mx-auto text-center  px-16 py-8 m-10 my-8 shadow-2xl rounded-lg'>
